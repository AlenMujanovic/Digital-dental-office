          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start">
              ...
              <Link to="/dashboard" className="text-xl font-bold flex items-center lg:ml-2.5">
                <img src={flouride} className="h-6 mr-2" alt="Windster Logo" />
                <span className="self-center whitespace-nowrap">Digital Dental Office</span>
              </Link>
            </div>
          </div>
        </div>
      </nav>
      <DashboardSidebar sidebarOpen={sidebarOpen} user={user?.results} />
    </>
  );
};
