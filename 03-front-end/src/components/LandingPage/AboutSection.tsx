        ...
        <div className="-mx-4 flex flex-wrap items-center justify-between">
          ...
          <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div className="mt-10 lg:mt-0">
              <span className="mb-2 block text-lg font-semibold text-primary">APPOINTMENT</span>
              ...
              <button className="inline-flex items-center justify-center rounded-lg bg-black py-4 px-10 text-center text-base font-normal text-white hover:bg-opacity-90 lg:px-8 xl:px-10">
                Learn More
              </button>
            </div>
          </div>
