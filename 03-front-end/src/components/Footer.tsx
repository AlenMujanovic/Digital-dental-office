...
const Footer = () => {
  return (
    <footer className="relative z-10 bg-white pt-20 p-4 pb-10 lg:pt-[120px] lg:pb-20">
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap">
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-dark">Services</h4>
              <ul>
                <li>
                  <span className="mb-2 inline-block text-base leading-loose text-body-color">Emergency Dental Care</span>
                </li>
                <li>
                  <span className="mb-2 inline-block text-base leading-loose text-body-color">Check Up</span>
                </li>
                <li>
                  <span className="mb-2 inline-block text-base leading-loose text-body-color">Treatment of Personal Diseases</span>
                </li>
                <li>
                  <span className="mb-2 inline-block text-base leading-loose text-body-color">Tooth Extraction</span>
                </li>
              </ul>
            </div>
          </div>
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-dark">Oral Health</h4>
              <ul>
                <li>
                  <span className="mb-2 inline-block text-base leading-loose text-body-color">Emergency Dental Care</span>
                </li>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="text-base text-body-color">&copy; 2023 Copyright</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <svg width="217" height="229" viewBox="0 0 217 229" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
              <linearGradient id="paint0_linear_1179_5" x1="76.5" y1="281" x2="76.5" y2="1.22829e-05" gradientUnits="userSpaceOnUse">
                <stop stopColor="#3056D3" stopOpacity="0.20" />
